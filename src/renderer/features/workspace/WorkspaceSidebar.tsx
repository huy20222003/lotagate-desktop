...
import { Blocks, ChevronDown, CirclePlus, Folder, PanelLeftClose, PanelLeftOpen, Pencil, Settings, ShieldCheck, X } from 'lucide-react';
...
export interface WorkspaceSidebarProps {
  ...
  accountOpen: boolean; onAccount: () => void; onCloseAccount: () => void; onSettings: () => void; onPlugins: () => void; onLogout: () => void;
...
export function WorkspaceSidebar({ accountName, avatarProps, workspaces, activeWorkspace, tasks, activeTask, loading, accountOpen, onAccount, onCloseAccount, onSettings, onPlugins, onLogout, onNewChat, onWorkspace, onTask, onAddWorkspace, onRenameWorkspace, onRemoveWorkspace, onArchiveTask, onPinTask, onRenameTask, collapsed, onToggleCollapsed, sidebarResizing, onStartResize, onResizeKeyDown }: WorkspaceSidebarProps) {
