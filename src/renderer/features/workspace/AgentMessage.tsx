...
export function AgentMessage({ activity, artifacts, timing, streaming = false, fileChangeSummary, progressActivities = [], toolActivities = [], workspaceCwd, onOpenFileChanges }: { activity: Activity; artifacts: Artifact[]; timing?: TurnTiming | undefined; streaming?: boolean; fileChangeSummary?: FileChangeSummary | undefined; progressActivities?: readonly Activity[]; toolActivities?: readonly Activity[]; workspaceCwd: string; onOpenFileChanges: (summary: FileChangeSummary) => void }) {
