...
function TaskConversation({ task, activities, activityAttachments, fileChangesByTurn, onOpenFileChanges, onOpenImage, statusText, contextCompactionStatus, thinking, thinkingStartedAt, turnTimings, trust, onTrust }: { task?: Task | undefined; activities: Activity[]; activityAttachments: Record<string, AttachmentPreview[]>; fileChangesByTurn: FileChangeSummariesByTurn; onOpenFileChanges: (summary: FileChangeSummary) => void; onOpenImage: (attachment: AttachmentPreview) => void; statusText?: string | undefined; contextCompactionStatus?: 'compacting' | 'compacted' | 'failed' | undefined; thinking: boolean; thinkingStartedAt?: number; turnTimings: Record<string, { startedAt: number; endedAt?: number }>; trust?: TrustRequest | undefined; onTrust: (trusted: boolean) => Promise<void> }) {
...
function TypingIndicator() {
  return <div className="typing-indicator" aria-live="polite" aria-label="Thinking...">
    <span className="typing-label" aria-hidden="true">Thinking</span>
