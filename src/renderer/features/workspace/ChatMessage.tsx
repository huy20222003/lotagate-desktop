...
export function ChatMessage({ activity, attachments, artifacts, timing, fileChangeSummary, workspaceCwd, onOpenFileChanges, onOpenImage }: { activity: Activity; attachments: AttachmentPreview[]; artifacts: Artifact[]; timing?: TurnTiming | undefined; fileChangeSummary?: FileChangeSummary | undefined; workspaceCwd: string; onOpenFileChanges: (summary: FileChangeSummary) => void; onOpenImage: (attachment: AttachmentPreview) => void }) {
  ...
  return <AgentMessage activity={activity} artifacts={artifacts} workspaceCwd={workspaceCwd} onOpenFileChanges={onOpenFileChanges} {...(timing === undefined ? {} : { timing })} {...(fileChangeSummary === undefined ? {} : { fileChangeSummary })} />;
}
