...
export function ChatMessage({ activity, attachments, timing, fileChangeSummary, onOpenFileChanges, onOpenImage }: { activity: Activity; attachments: AttachmentPreview[]; timing?: TurnTiming | undefined; fileChangeSummary?: FileChangeSummary | undefined; onOpenFileChanges: (summary: FileChangeSummary) => void; onOpenImage: (attachment: AttachmentPreview) => void }) {
