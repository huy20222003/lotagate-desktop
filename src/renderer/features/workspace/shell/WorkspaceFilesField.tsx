...
import type { PickedWorkspaceFile } from '../composer/slash-command-view-types.js';
import { displayFileName, formatBytes } from '../composer/slash-command-format.js';
