...
export function AttachmentPreviewList({ taskId, attachments, onRemove, className, inline = className === 'queued-attachment-list' }: { taskId?: string; attachments: readonly AttachmentPreview[]; onRemove?: (attachmentId: string) => Promise<void>; className?: string; inline?: boolean }) {
