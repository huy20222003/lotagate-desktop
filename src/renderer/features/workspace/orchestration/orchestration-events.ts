...
function readEvidenceKind(value: unknown): WorkEvidenceSnapshot['kind'] | undefined { return value === 'read' || value === 'diff' || value === 'test' || value === 'typecheck' || value === 'lint' || value === 'build' || value === 'runtime' ? value : undefined; }
