...
export function useDraftPersistence({ taskRef, onError }: DraftPersistenceOptions): { updateDraft: (draft: string) => Promise<void>; flushDraft: () => Promise<void> } {
