...
import { ArrowLeft, Blocks, Brain, CreditCard, Info, KeyRound, Keyboard, MonitorCog, Plug, Puzzle, RefreshCw, ShieldCheck, UserRound, Workflow, Globe2, Settings2 } from 'lucide-react';
...
export type SettingsSection = 'general' | 'profile' | 'api-key' | 'billing' | 'appearance' | 'keyboard-shortcuts' | 'browser' | 'sandbox' | 'memory' | 'about' | ExtensionKind;
