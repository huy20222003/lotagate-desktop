...
export function SettingsPage({ user, workspace, workspaces, mcpStatuses = {}, onBack, keyboardShortcuts, onUpdateShortcut, initialSection = 'profile' }: { user: UserProfile; workspace?: Workspace; workspaces: Workspace[]; mcpStatuses?: Record<string, McpRuntimeStatus>; onBack: () => void; keyboardShortcuts: KeyboardShortcutBindings; onUpdateShortcut: (action: KeyboardShortcutAction, shortcut: string | null) => Promise<void>; initialSection?: SettingsSection }) {
